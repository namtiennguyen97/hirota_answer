function classesAnswer(){
    let htmlAnswer = "<p class='titleMidtest'>Danh sách các class cơ bản của Izanagi</p><br><div class='row row-cols-1 row-cols-md-2 g-4'>" +
        ...
        "<button class='btn btn-primary' onclick='showModalAssasin()'>Xem thêm về nhánh chuyển nghề Assasin <i class=\"fas fa-user-ninja\"></i></button>"+
        "      </div>" +
        "    </div>" +
        "  </div>" +
        "  <div class='col'>" +
        ...
        "<button class='btn btn-danger' onclick='showModalMage()'>Xem thêm về nhánh chuyển nghề Mage <i class=\"fas fa-hat-wizard\"></i></button>"+
        "      </div>" +
        "    </div>" +
        "  </div>" +
        "  <div class='col'>" +
        ...
        "<button class='btn btn-success' onclick='showModalCleric()'>Xem thêm về nhánh chuyển nghề Cleric <i class=\"fas fa-gavel\"></i></button>"+
        "      </div>" +
        "    </div>" +
        "  </div>" +
        "  <div class='col'>" +
        ...
        "<button class='btn btn-info' onclick='showModalWarrior()'>Xem thêm về nhánh chuyển nghề Warior <i class=\"fas fa-shield-alt\"></i></button>"+
        "      </div>" +
        "    </div>" +
        "  </div>" +
        "</div>";
...
function showModalMage(){
    $('#modalMage').modal('show');
}
function showModalCleric(){
    $('#modalCleric').modal('show');
}
function showModalWarrior(){
    $('#modalWarrior').modal('show');
}